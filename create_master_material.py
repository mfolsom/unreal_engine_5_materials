...
# save the assets
editor_asset_library.save_asset("/Game/Content/Materials/M_GenericMaterial", True)
editor_asset_library.save_asset("/Game/Content/Materials/MI_GenericMaterial", True)
